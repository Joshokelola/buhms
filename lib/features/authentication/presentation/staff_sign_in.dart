//TODO - CHECK STAFF TABLE IF SIGNED IN USER IS PRESENT THERE. CHECK ROLE AS WELL.
...
class StaffSignInPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<StaffSignInPage> createState() => _SignInPageState();
}

class _SignInPageState extends ConsumerState<StaffSignInPage> {
  ...
  Widget build(BuildContext context) {
    ref.listen(authNotifierProvider, (previous, next) {
      next.maybeWhen(
        orElse: () => null,
        authenticated: (user) {
          context.replaceRoute(const AdminDashboardScreen());
        },
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  ref.read(authNotifierProvider.notifier).loginStaff(

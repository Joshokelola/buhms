...
extension MediaQueryExtension on BuildContext {
  ...
  double get onePercentWidth => width * 0.01;
  double get twoPercentWidth => width * 0.02;
  double get fivePercentWidth => width * 0.05;
  double get tenPercentWidth => width * 0.1;

  /// Returns 5% of the screen height
  double get highValue => height * 0.05;
  double get sevenPercentValue => height * 0.07;
